...
try:
    if 'Home Event_14' in match_data:
        match_data['Home Event_14'] = match_data['Home Event_14']
    else:
        match_data['Home Event_14'] = pd.series(
            [pd.nan for x in range(len(match_data.index))]
        )
